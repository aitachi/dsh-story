...
export function nativeProductionPrompt(production, job, references) {
...
export function nativeBatchPrompt(production, job, candidates) {
    return `/short-drama-produce
...
export function nativeCompositionPrompt(production, job, orderedPaths) {
    return `/short-drama-produce
...
//# sourceMappingURL=production-prompts.js.map